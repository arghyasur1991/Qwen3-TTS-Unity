...
{
    /// <summary>
    /// Row-major float32 matrix in AllocHGlobal, off the managed heap so a
    /// multi-hundred-megabyte table is neither scanned by the GC nor pinned.
    /// Not reference-counted: the owner calls <see cref="Free"/> exactly once.
    /// </summary>
